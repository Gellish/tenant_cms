<div class="content-wrapper">
    <h3>Utility Bill
        <small>List of all Utility Bills</small>
    </h3>
                    ...
                    <table id="datatable1" class="table table-striped table-hover">
						...
						?>
                            <tr>
                                ...
                                <td><?php echo html_escape($this->db->get_where('utility_bill_category', array('utility_bill_category_id' => $utility_bill['utility_bill_category_id']))->row()->name); ?></td>
                                ...
                                <td>
									<?php
										...
										if ($user_type == 1) {
											...
											$staff_id = $this->db->get_where('user', array('user_id' => $utility_bill['created_by']))->row()->staff_id;
                                ...
                                <td>
									<?php
										...
										if ($user_type == 1) {
											...
											$staff_id = $this->db->get_where('user', array('user_id' => $utility_bill['updated_by']))->row()->staff_id;
											echo html_escape($this->db->get_where('staff', array('staff_id' => $staff_id))->row()->name); 
										}
									?>
                                </td>
                                <td>
									<div class="btn-group mb-sm">
										...
										<ul role="menu" class="dropdown-menu">
											<li>
												<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_edit_utility_bill/<?php echo $utility_bill['utility_bill_id']; ?>');">
													Edit
												</a>
											</li>
											<li>
												<a href="javascript:;" onclick="confirm_modal('<?php echo base_url(); ?>utility_bills/remove/<?php echo $utility_bill['utility_bill_id']; ?>');" >
													Remove
												</a>
											</li>
										</ul>
