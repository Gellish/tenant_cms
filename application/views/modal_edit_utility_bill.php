<?php echo form_open('utility_bills/update/' . $param2, array('id' => 'edit_utility_bill', 'method' => 'post', 'data-parsley-validate' => '')); ?>
<?php
...
?>
	...
	<div class="form-group">
		<label>Status</label>
		<select class="chosen-select input-md" name="status" data-parsley-required="true">
