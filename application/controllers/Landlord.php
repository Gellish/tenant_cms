...
class Landlord extends CI_Controller {
	...
	{	
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_room'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function rooms($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'rooms'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_bed()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_bed'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function beds($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'beds'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_tenant()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_tenant'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function tenants($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'tenants'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_utility_bill()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_utility_bill'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function utility_bills($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'utility_bills'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function utility_bill_categories($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'utility_bill_categories'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_expense()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_expense'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function expenses($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'expenses'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_staff()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_staff'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function staff($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'staff'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function add_staff_payroll()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'add_staff_payroll'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function staff_payroll($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'staff_payroll'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function generate_rent($param = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'generate_rent'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function monthly_rent()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'monthly_rent'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function rents($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'rents'))->row()->page_id, $this->session->userdata('permissions'))) {
			if ($param1 == 'update') $this->model->update_tenant_rent($param2);
			elseif ($param1 == 'remove') $this->model->remove_tenant_rent($param2);
			
			$page_data['page_title']	=	'All Rents';
	...
	function account()
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'account'))->row()->page_id, $this->session->userdata('permissions'))) {
			$page_data['page_title']	=	'Acoount';
	...
	function website_settings($param = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'website_settings'))->row()->page_id, $this->session->userdata('permissions'))) {
			if ($param == 'update') $this->model->update_website_settings();
			if ($param == 'update_logo') $this->model->update_website_logo();
	...
	function profession_settings($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'profession_settings'))->row()->page_id, $this->session->userdata('permissions'))) {
	...
	function id_type_settings($param1 = '', $param2 = '')
	{
		...
		if (in_array($this->db->get_where('page', array('page_name' => 'id_type_settings'))->row()->page_id, $this->session->userdata('permissions'))) {
