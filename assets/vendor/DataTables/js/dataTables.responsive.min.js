	...
	c.extend(h.prototype, {
			...
			e.each(function(b, e) {
				for (var d = b.className.split(" "), f = !1, h = 0, k = d.length; h < k; h++) {
					...
					c.each(a, function(a, b) {
						var c = b.name.split("-"),
							d = j.match(RegExp("(min\\-|max\\-|not\\-)?(" + c[0] + ")(\\-[_a-zA-Z0-9])?"));
		...
		_resizeAuto: function() {
			...
			if (this.c.auto && -1 !== c.inArray(!0, c.map(a, function(a) {
				...
				c.isEmptyObject(l) || c.each(l, function(a) {
					a = a.split("-");
					r(b, 1 * a[0], 1 * a[1])
				});
				b.table().node();
		...
		listHiddenNodes: function() {
			return function(b, a, d) {
				...
				c.each(d, function(a, d) {
					d.hidden && (c('<li data-dtr-index="' + d.columnIndex + '" data-dt-row="' + d.rowIndex + '" data-dt-column="' + d.columnIndex + '"><span class="dtr-title">' + d.title + "</span> </li>").append(c('<span class="dtr-data"/>').append(s(b, d.rowIndex, d.columnIndex))).appendTo(e), f = !0)
				});
				return f ? e : !1
			}
		},
